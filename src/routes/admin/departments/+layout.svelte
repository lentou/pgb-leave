		...
		<div class="pt-7">
			<Breadcrumb.Root>
				<Breadcrumb.List>
					...
					<Breadcrumb.Item>
						<Breadcrumb.Page>Departments</Breadcrumb.Page>
					</Breadcrumb.Item>
				</Breadcrumb.List>
			</Breadcrumb.Root>
		</div>
		<p class="mb-16 text-4xl font-bold text-slate-800 max-lg:text-2xl">Manage Departments</p>
					...
					<Dialog.Content>
						<Dialog.Header>
							...
							<form method="POST" action="?/add_department">
								<Form.Field {form} name="departmentName">
									<Form.Control let:attrs>
										<Form.Label>Department Name</Form.Label>
										<Input {...attrs} bind:value={$formData.departmentName} />
									</Form.Control>

									<Form.FieldErrors />
								</Form.Field>
								<Form.Field {form} name="departmentCode">
									<Form.Control let:attrs>
										<Form.Label>Department Code</Form.Label>
										<Input {...attrs} bind:value={$formData.departmentCode} />
									</Form.Control>
